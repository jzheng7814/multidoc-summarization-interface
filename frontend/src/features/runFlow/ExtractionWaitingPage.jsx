...
function parseExtractionStage(payload) {
...
const ExtractionWaitingPage = ({
    ...
    const handleStagePayload = useCallback((payload) => {
        const next = parseExtractionStage(payload);
        setStage(next);
        return next;
    }, []);
    ...
    const pollStatus = useCallback(async () => {
        try {
            const payload = await fetchRunExtractionStatus(runId);
...
export default ExtractionWaitingPage;
